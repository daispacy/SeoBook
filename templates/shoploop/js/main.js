...
$(function(){
	...
	$('<h6 class="open_nav">Menu</h6>').appendTo('#topHeader div.sixteen');
...
$(function(){
	...
	$('#active-bg').remove();
	$('head')
	.append('<link rel="stylesheet" id="active-bg" href="/templates/shoploop/css/bg/'+get_cookie+'.css">');
	...
	$("#sideWidget div.bgPatterns").find('a').bind('click', function(e) {
		...
		$('head')
		.append('<link rel="stylesheet" id="active-bg" href="/templates/shoploop/css/bg/'+bgName+'.css">');
	});
});
/*=========== end it ==========*/
