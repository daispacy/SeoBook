...
# Debug options
define('DEBUG1', '1');						# Debug mode
define('DEBUG_DISPLAY', '0');				# Display debug information
define('DEBUG_IP', '115.78.94.127');		# This IP will see the debug information
define('DEBUG_FILE_APPEND', 0);				# Debug file write mode - 8 for append, 0 for overwrite
...
# Key Setting
define('APP_KEY', 'D3raCMSver30');	
define('API_KEY', 'AFHI4SD9MZX4222');		# App key for special requests (like crontab,...)
...
define('DOMAIN', 'HungPhatInterior.com');		# Main domain name
