...
include_once(ROOT_PATH.'classes/dao/projectinfo.class.php');
...
class Projects extends Model {
	...
	function Projects($store_id = 0, $database = '') {
		if(!$database) {
			global $db;
			$this->_db = $db;
		} else $this->_db = $database;
		$this->table = DB_PREFIX."project";
