<?php /* Smarty version Smarty-3.0-RC2, created on 2015-04-18 16:05:19
         compiled from "./templates/admin/manageproduct.tpl.html" */ ?>
<?php /*%%SmartyHeaderCode:139146437755321e4f13dd12-08890859%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '85884d4c815f276dd19235be66cb1c9faaf3de40' => 
    array (
      0 => './templates/admin/manageproduct.tpl.html',
      1 => 1429347788,
    ),
  ),
  'nocache_hash' => '139146437755321e4f13dd12-08890859',
  'function' => 
  array (
  ),
...
<select name="dk">
<option value="">----- Lọc đặc biệt -----</option>
<option <?php if ($_smarty_tpl->getVariable('dk')->value=="home=1"){?>selected<?php }?> value="home=1">Mới</option>
<option <?php if ($_smarty_tpl->getVariable('dk')->value=="seller=1"){?>selected<?php }?> value="seller=1">Ưa chuộng</option>
<option <?php if ($_smarty_tpl->getVariable('dk')->value=="special=1"){?>selected<?php }?> value="special=1">Khuyến mãi</option>
</select>
