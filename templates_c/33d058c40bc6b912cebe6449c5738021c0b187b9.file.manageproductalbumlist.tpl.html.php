<?php /* Smarty version Smarty-3.0-RC2, created on 2015-04-18 12:53:55
         compiled from "./templates/admin/manageproductalbumlist.tpl.html" */ ?>
<?php /*%%SmartyHeaderCode:14154037085531f17300b9d0-68173116%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '33d058c40bc6b912cebe6449c5738021c0b187b9' => 
    array (
      0 => './templates/admin/manageproductalbumlist.tpl.html',
      1 => 1428722926,
    ),
  ),
  'nocache_hash' => '14154037085531f17300b9d0-68173116',
  'function' => 
  array (
  ),
...
<td><?php echo $_smarty_tpl->getVariable('item')->value->getNameProduct();?>
</td>
<td><?php echo $_smarty_tpl->getVariable('item')->value->getNumberPhoto();?>
...
?op=manage&act=product&mod=albumedit&id=<?php echo $_smarty_tpl->getVariable('item')->value->getId();?>
...
<a href="javascript:formSubmit('formType','albumlist','enable',<?php echo $_smarty_tpl->getVariable('item')->value->getId();?>
...
" width="16" height="16" /></a>
<a href="javascript:formSubmit('formType','albumlist','disable',<?php echo $_smarty_tpl->getVariable('item')->value->getId();?>
...
" width="16" height="16" /></a>
<a href="javascript:formSubmit('formType','albumlist','delete',<?php echo $_smarty_tpl->getVariable('item')->value->getId();?>
...
" href="javascript:void(0);" onclick="javascript:formSubmit('formType','albumlist','changeposition','0');;"><?php echo $_smarty_tpl->getVariable('locale')->value->msg('button_update');?>
</a>
<a title="<?php echo $_smarty_tpl->getVariable('locale')->value->msg('button_enable');?>
" href="javascript:void(0);" onclick="javascript:formSubmit('formType','albumlist','enable','0');;"><?php echo $_smarty_tpl->getVariable('locale')->value->msg('button_enable');?>
</a>
<a title="<?php echo $_smarty_tpl->getVariable('locale')->value->msg('button_disable');?>
" href="javascript:void(0);" onclick="javascript:formSubmit('formType','albumlist','disable','0');"><?php echo $_smarty_tpl->getVariable('locale')->value->msg('button_disable');?>
</a>
<a title="<?php echo $_smarty_tpl->getVariable('locale')->value->msg('button_delete');?>
" href="javascript:void(0);" onclick="javascript:formSubmit('formType','albumlist','delete','0');"><?php echo $_smarty_tpl->getVariable('locale')->value->msg('button_delete');?>
</a>
</p>
...
" class="btnSubmit2" name="btnSubmit2" onclick="javascript:formSubmit('formType','albumlist','changegroup','0');" />
</div>
</div>
<input type="hidden" name="op" value="manage" />
<input type="hidden" name="act" value="product" />
<input type="hidden" name="mod" value="albumlist" />
